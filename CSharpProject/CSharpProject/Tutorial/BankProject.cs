...
10242020	  Multiple Exception class
**/
	...
	public class BankProject
	{
		...
		public static void testMain()
		{
			...
			*/
			...
			Console.WriteLine("Test multiple exception");
			try
			{
				testMultExcep = new Account("Rob", "");
			}
